...
namespace ETicaretAPI_V2.API.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpPut]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Updating, Definition = "Uptade Quantity")]
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Deleting, Definition = "Remove BasketItem")]
